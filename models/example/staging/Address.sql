...
SELECT
    ...
    md5(us_geo_parts.state_name || us_geo_parts.county_name ||
     us_geo_parts.city_name || us_geo_parts.zip_code ||
      sources_full_address.address) AS id
FROM
    sources_full_address
LEFT JOIN
    us_geo_parts
